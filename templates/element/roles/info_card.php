...
<div class="card card-flush h-md-100">
    ...
    <div class="card-footer flex-wrap pt-0">
        <button data-role-id="<?= $role->id ?? 0 ?>" type="button" class="btn btn-light btn-active-light-primary my-1 btn-edit-roles" data-bs-toggle="modal" data-bs-target="#kt_modal_edit-role">Edit Role</button>
    </div>
